...
#upstream="fbank apc_960hr vq_apc_960hr npc_960hr mockingjay_960hr tera_960hr modified_cpc wav2vec2_large_ll60k wav2vec2_xlsr hubert_base unispeech_sat_base unispeech_sat_base_plus unispeech_sat_large wavlm_base_plus wavlm_large"


for i in $upstream; do
    echo "Running $i"
    python run_downstream.py -d jtes -m train -n jtes-$i -u $i
done
